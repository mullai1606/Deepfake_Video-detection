...
from Load_model import load_mobilenetv2_224_075_detector


def run(inputvidpath):
        vidname= inputvidpath.split("/")[-1]
        modelpath = "facedetection-mobilenetv2-size224-alpha0.75.h5"
        newmodelpath = "A18_ChkpointXception10weights.h5"
        ...
        #load_mobilenetv2_224_075_detector(path="facedetection-mobilenetv2-size224-alpha0.75.h5")
        ...
        prediction.predict_video(facepath=facestoragepath, newmodel=load_model("A18_ChkpointXception10weights.h5"))

inputvidpath = "VID20241114192200.mp4"
run(inputvidpath)


# modelpath = "facedetection-mobilenetv2-size224-alpha0.75.h5"
#newmodel=load_model("A18_ChkpointXception10weights.h5")
# path="Out/sample-images/"+vidname
# framepath = path+"/splitFrames/"
# facestoragepath= path+"ExtractedFrames"+vidname
